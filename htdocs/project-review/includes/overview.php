<div class="row">
	<div class="col-sm-4 thumbnail">
		<h4>
			Top Ten Training Departments This Month:
		</h4>
		<div class="row">
			<div class="col-sm-2">
				012
			...
			<div class="col-sm-10">
				<div class="progress">
					<div class="progress-bar" role="progressbar" aria-valuenow="13" aria-valuemin="0" aria-valuemax="100" style="width: 13%;">
						<span class="sr-only">12.5% Complete</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-10">
				<div class="progress">
					<div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 1%;">
	...
	<div class="col-sm-4 thumbnail">
		<h4>
			Active Corses taught this week:
		</h4>
		<div class="row">
			<div class="col-sm-2">
				012
	...
	<div class="col-sm-4 thumbnail">
		<h4>
			Instructors Expiring in the Next Week:
		</h4>
		<table class="table">
			<tr>
				<td>
